import { StyleSheet, Text, View, ScrollView, TouchableHighlight, Dimensions, TextInput, TouchableOpacity } from "react-native";
...
function Profile() {
  ...
  const [ bio, setBio ] = useState("On a scale from one to Slurpees on 7/11: how free are you tonight?");
    ...
    <ScrollView>
      <View style={styles.profile}>
        ...
        <View style={styles.row}>
          {poems.length < 3 ? <TouchableOpacity style={styles.poemContainer} onPress={() => setAddPoem(-1)}>
